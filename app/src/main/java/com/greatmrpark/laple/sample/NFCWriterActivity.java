...
public class NFCWriterActivity extends AppCompatActivity {
    ...
    public static final String ERROR_DETECTED = "NFC 태그가 감지되지 않았습니다!";
    public static final String WRITE_SUCCESS = "NFC 태그에 성공적으로 쓰여진 텍스트!";
    public static final String WRITE_ERROR = "쓰기 중 오류가 발생했습니다. NFC 태그가 기기에 충분히 근접합니까?";
